Attribute VB_Name = "Module24_PivotACH"
Option Explicit

Sub Generate_Pivot_Table_04_ACH11151127()
...
With wsPT.PivotTables(sNamePivotTable).PivotFields("Entry Description")
    .Orientation = xlRowField
    '.Orientation = xlColumnField
    .AutoSort xlAscending, "Entry Description"
    .Position = 1
End With

With wsPT.PivotTables(sNamePivotTable).PivotFields("Recon Date")
    .Orientation = xlRowField
    '.Orientation = xlColumnField
    .AutoSort xlAscending, "Recon Date"
    .Position = 2
End With
...
With wsPT.PivotTables(sNamePivotTable)
    .PivotFields("Entry Description").Subtotals = Array(False, False, False, False, False, False, False, False, False, False, False, False)
    .PivotFields("Recon Date").Subtotals = Array(False, False, False, False, False, False, False, False, False, False, False, False)
End With
...
wsPT.Cells(irowpt - 2, iColPT) = "ACH_1127"
